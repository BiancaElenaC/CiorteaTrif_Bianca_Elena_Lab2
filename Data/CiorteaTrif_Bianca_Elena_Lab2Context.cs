...
namespace CiorteaTrif_Bianca_Elena_Lab2.Data
{
    public class CiorteaTrif_Bianca_Elena_Lab2Context : DbContext
    {
        ...
        public DbSet<CiorteaTrif_Bianca_Elena_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<CiorteaTrif_Bianca_Elena_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
