...
options.UseSqlServer(builder.Configuration.GetConnectionString("CiorteaTrif_Bianca_Elena_Lab2Context") ?? throw new InvalidOperationException("Connectionstring 'CiorteaTrif_Bianca_Elena_Lab2Context' not found.")));
